...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-[#00283C] px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-slate-300 text-lg leading-relaxed mb-12 max-w-2xl mx-auto">
            Hiện tại tôi đang tìm kiếm cơ hội mới để đóng góp và phát triển. Nếu
            bạn có một dự án thú vị hoặc đơn giản là muốn trao đổi, đừng ngần
            ngại liên hệ với tôi!
          </p>
